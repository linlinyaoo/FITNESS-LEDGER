...
# Capacitor discovers plugin permissions through runtime annotations.
...
# Keep Capacitor runtime annotations and the Camera plugin metadata used by reflection.
